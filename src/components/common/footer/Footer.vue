      ...
      <div class="am-g">
        <div class="am-u-md-6 ">
          <div class="footer_main--column">
            <strong class="footer_main--column_title">{{ $t('message.downloadLink') }}</strong>
            ...
            <div class="footer_about">
              <p class="footer_about--text">
                {{ $t('message.refer') }} <a
                  ...
                  target="_blank"
                >https://docs.rs/rustsbi/latest/rustsbi</a> 
              </p>
            </div>
          </div>
        </div>
        <div class="am-u-md-6 ">
          <div class="footer_main--column">
            <strong class="footer_main--column_title">{{ $t('message.contactDetails') }}</strong>
            <ul class="footer_contact_info">
              ...
              <li class="footer_contact_info--item">
                ...
                /><span>{{ $t('message.contactAddress') }}</span>
              </li>
            </ul>
          </div>
        </div>
